...
run_spec(spec_label = "no_cmig_no_cfx",
         dataset = "census", threshold = 25L,
         c_mig = T,   # ← drop year × mig_intensity
         c_fx  = TRUE,   # ← drop year × fx
         c_block_a = T, c_block_b = F, c_block_c = T)
