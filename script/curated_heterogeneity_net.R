...
CENSUS_OUTCOMES <- c(
  # first-stage proxy  (slide: First-stage results)
  "absent_hh_share",
  # HH physical investment  (slide: Household physical investment)
  "amen_asset_count_mean", "housing_foundation_modern", "amen_toilet_any",
  # human capital  (slide: Human capital investment)
  "edu_literate", "edu_literate_female", "edu_school_attend_6_16",
  # sectors  (slide: Employment by sector)
  ...
  # occupations  (slide: Occupational shift)
...
HH_OUTCOMES <- c(
  # first-stage on HH side  (slide: First-stage results)
  "log_remit_amount_intl_12m_rs", "log_n_migrants_international",
  # human capital — health  (slide: Human capital investment)
  "hlt_spend_total",
  # land use  (slide: Agricultural practice — land use & cropping)
